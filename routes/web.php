...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('reported-contents', [App\Http\Controllers\Admin\ContentController::class, 'reportedIndex'])->name('contents.reported');
    Route::get('reported-contents/{report}', [App\Http\Controllers\Admin\ContentController::class, 'reviewReport'])->name('contents.review_report');
    Route::post('reported-contents/{report}/resolve', [App\Http\Controllers\Admin\ContentController::class, 'resolveReport'])->name('contents.resolve_report');
    Route::post('reported-contents/{report}/reject', [App\Http\Controllers\Admin\ContentController::class, 'rejectReport'])->name('contents.reject_report');
});
...
// User Content Listing & Reporting
...
Route::middleware(['auth'])->group(function () {
    Route::get('/contents/{content}/report', [App\Http\Controllers\ContentController::class, 'reportForm'])->name('contents.report');
    Route::post('/contents/{content}/report', [App\Http\Controllers\ContentController::class, 'reportSubmit'])->name('contents.report.submit');
});

// Public content preview for landing page
Route::get('/content-previews', [App\Http\Controllers\ContentController::class, 'index'])->name('content.previews');

<aside class="w-64 h-screen bg-gradient-to-b from-purple-900 to-purple-800 border-r border-purple-700/50 flex flex-col fixed top-0 left-0 z-30 shadow-2xl">
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        ...
        <div class="pt-6">
            ...
            <a href="{{ route('sessions.manage') }}" class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('sessions.manage') ? 'bg-gradient-to-r from-purple-600 to-purple-500 text-white shadow-lg shadow-purple-500/25' : 'text-purple-300 hover:bg-purple-700/50 hover:text-white' }}">
                <div class="flex items-center justify-center w-8 h-8 mr-3 rounded-lg {{ request()->routeIs('sessions.manage') ? 'bg-white/20' : 'bg-purple-700/50 group-hover:bg-purple-600/50' }}">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">

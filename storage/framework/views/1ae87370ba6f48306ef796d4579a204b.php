        ...
        <div class="container">
            ...
            <section class="hero-section">
                ...
                <div class="cta-buttons">
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-hero">
                        🚀 Join as Student
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary btn-hero">
                        💼 Become a Tutor
                    </a>
                </div>
            </section>
            ...
            <section class="hero-section" style="margin-top: 4rem;">
                ...
                <div class="cta-buttons">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary btn-hero">
                        Sign In
                    </a>
                </div>
            </section>
...
</html><?php /**PATH E:\PAW\Mentora\resources\views/welcome.blade.php ENDPATH**/ ?>